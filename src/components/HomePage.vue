...
<template>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <h6 class="display-4">Find your job!</h6>
        </div>
